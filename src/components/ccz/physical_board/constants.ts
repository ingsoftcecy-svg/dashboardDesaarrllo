...
export const STRINGS = {
  ...
  SELECT_IPS_SUBTITLE: "IPs Asignadas al Operador",
  GLOBAL_BANK_SUBTITLE: "Banco Global del Área (Clic para asignar)",
  GLOBAL_LIST_SUBTITLE: "Crear Nueva IP para el Banco",
  ADD_BUTTON: "AÑADIR",
